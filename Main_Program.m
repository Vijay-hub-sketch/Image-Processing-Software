...
message = sprintf('Area=%.2f  \nPerimeter=%.2f \nMean value within drawn area = %.3f \nMajor Axis Length=%.2f \nMinor Axis Length=%.2f',area,perimeter,meanGL,MAxisLength,MiAxisLength);
I = croppedImage;
...
set(handles.edit17,'string',area*(0.2645833333/70));
set(handles.edit18,'string',perimeter*(0.2645833333/5));
set(handles.edit19,'string',meanGL*(0.2645833333/5));
set(handles.edit20,'string',MAxisLength*(0.2645833333/5));
set(handles.edit21,'string',MiAxisLength*(0.2645833333/5));
